...
<table border=0 width=100%>
  <tr>
    ...
    <td width="520"align="center">Mengetahui <br> Kepala SMA IBNU HAJAR BOARDING SCHOOL</td>
    <td width="260" align="left">Depok, <?php echo tgl_raport(date("Y-m-d")); ?> <br> Wali Kelas</td>
  </tr>
  <tr>
