<?php 
    if (isset($_POST[simpan])){
      if ($_POST[status]=='Update'){
        ...
        mysql_query("INSERT INTO rb_nilai_keterampilan VALUES('','$_GET[jdwl]',$_GET[kdpelajaran],'$_POST[nisn]','$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','$_POST[g]','$_POST[h]','$_SESSION[id]','".date('Y-m-d H:i:s')."')");
      }
