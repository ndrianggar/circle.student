...
<?php 
  ...
  if ($_GET[gettgl]){
    ...
    echo "<div class='col-md-12'>
              ...
              <form action='index.php?view=absensiswa&act=tampilabsen&id=$_GET[id]&kd=$_GET[kd]&jdwl=$_GET[jdwl]&ie=$_GET[ie]' method='POST' class='col-md-7 pull-right' style='margin-bottom:5px'>
                ...
                if (isset($_POST[simpann])){
                    ...
                    for ($i=1; $i <= $jml_data; $i++){
                      ...
                      if ($total >= 1){
                        ...
                        mysql_query("INSERT INTO rb_absensi_siswa VALUES('','0','".$_POST[jdwl]."','".$h."','".$nisn[$i]."','".$a[$i]."','".$e."-".$f."-".$g."','".date('Y-m-d H:i:s')."')");
                      }
                    }
