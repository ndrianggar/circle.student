            ...
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><?php echo "Journal Kegiatan Belajar Mengajar anda pada $tahunakademik[id_tahun_akademik]" ; ?></h3>
                ...
                <div class="box-body">
                  ...
                  <?php
                    if (isset($_GET[tahun])){
                      $tampil = mysql_query("SELECT a.*, e.nama_kelas,m.nm_pararel, b.namamatapelajaran, b.kode_pelajaran, c.nama_guru, d.nama_ruangan FROM rb_jadwal_pelajaran a 
                      ...
                      $tampil = mysql_query("SELECT a.*, e.nama_kelas,m.nm_pararel, b.namamatapelajaran, b.kode_pelajaran, c.nama_guru, d.nama_ruangan FROM rb_jadwal_pelajaran a 
                                            JOIN rb_mata_pelajaran b ON a.kode_pelajaran=b.kode_pelajaran
                                              JOIN rb_guru c ON a.nip=c.nip 
                                                ...
                                                JOIN rb_kelas e ON a.kode_kelas=e.kode_kelas 
												 JOIN rb_kls_pararel m ON a.id_kls_pararel=m.id_kls_pararel 	
                                                  where a.nip='$_SESSION[id]' AND a.id_tahun_akademik='$tahunakademik[id_tahun_akademik]' AND AND hari='$hari' ORDER BY a.hari DESC");
                    }
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td style='width:80px !important'><center>
                                        <a class='btn btn-success btn-xs' title='Lihat Journal' href='index.php?view=journalguru&act=lihat&id=$r[kodejdwl]&ie=$r[id_kls_pararel]'><span class='glyphicon glyphicon-search'></span> Lihat Journal</a>
                                      </center></td>
                          </tr>";
                      $no++;
                      }
...
<?php 
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='#' type='button' class='btn btn-default pull-right' onclick='window.history.back()'>Cancel</a>
