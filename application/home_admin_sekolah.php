            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <?php $siswa = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM rb_siswa where unit='$_SESSION[unit]'")); ?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                <?php $guru = mysql_fetch_array(mysql_query("SELECT count(*) as total FROM rb_guru where unit='$_SESSION[unit]'")); ?>
