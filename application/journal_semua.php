...
<?php 
    ...
    $d = mysql_fetch_array(mysql_query("SELECT a.kode_kelas, b.nama_kelas, c.kode_pelajaran, c.namamatapelajaran, c.tingkat, d.nama_guru, e.id_kls_pararel, e.nm_pararel FROM `rb_jadwal_pelajaran` a JOIN rb_kelas b ON a.kode_kelas=b.kode_kelas JOIN rb_mata_pelajaran c ON a.kode_pelajaran=c.kode_pelajaran JOIN rb_guru d ON a.nip=d.nip JOIN rb_kls_pararel e ON a.id_kls_pararel=e.id_kls_pararel where a.kodejdwl='$_GET[id]'"));
            echo "<div class='col-xs-12'>  
              <div class='box'>
                <div class='box-header'>
                  <h3 class='box-title'>Journal Kegiatan Belajar Mengajar</h3>
                      <a style='margin-left:5px' class='pull-right btn btn-success btn-sm' href='index.php?view=kompetensidasar&act=lihat&id=$d[kode_pelajaran]&tingkat=$d[tingkat]'>Lihat Kompetensi Dasar</a>";
                ...
                <div class='col-md-12'>
                  ...
                  <input type='hidden' name='jdwl' value='$_GET[jdwl]'>
                    <tr><th width='140px' scope='row'>Kelas</th>   <td><select class='form-control' name='a'>"; 
					 ...
					 <tr><th width='140px' scope='row'>Kelas Pararel</th>   <td><select class='form-control' name='h'>"; 
