                      ...
                      $tampil = mysql_query("SELECT a.*, e.nama_kelas, m.nm_pararel, b.namamatapelajaran, b.kode_pelajaran, c.nama_guru, d.nama_ruangan FROM rb_jadwal_pelajaran a 
                                            JOIN rb_mata_pelajaran b ON a.kode_pelajaran=b.kode_pelajaran
                                              JOIN rb_guru c ON a.nip=c.nip 
                                                ...
                                                JOIN rb_kelas e ON a.kode_kelas=e.kode_kelas 
												JOIN rb_kls_pararel m ON a.id_kls_pararel=m.id_kls_pararel
                                                  where a.nip='$_SESSION[id]' AND a.id_tahun_akademik='$tahunakademik[id_tahun_akademik]' AND hari='$hari' ORDER BY a.hari DESC");
             /*       }*/
                    $no = 1;
...
<?php 
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=kompetensiguru' class='btn btn-default pull-right'>Cancel</a>
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='index.php?view=kompetensiguru'  type='button' class='btn btn-default pull-right'>Cancel</a>
