                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                        ...
                        echo "<td><center>
                                ...
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='index.php?view=kurikulum&hapus=$r[kode_kurikulum]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </center></td>";
                             }
                            echo "</tr>";
                      $no++;
...
<?php 
    ...
    if (isset($_POST[tambah])){
        mysql_query("INSERT INTO rb_kurikulum VALUES('','$_POST[a]','$_POST[b]')");
        echo "<script>document.location='index.php?view=kurikulum';</script>";
    }
