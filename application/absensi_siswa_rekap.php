                  ...
                  <?php
                    ...
                    echo "<tr><td>$no</td>
                        ...
                        echo "<td style='width:70px !important'><center>
                                <a class='btn btn-success btn-xs' title='Tampil List Absensi' href='index.php?view=rekapabsensiswa&act=tampilabsen&id=$r[kode_kelas]&kd=$r[kode_pelajaran]&jdwl=$r[kodejdwl]&tahun=$_GET[tahun]&ie=$r[id_kls_pararel]'><span class='glyphicon glyphicon-th'></span> Tampilkan</a>
                              </center></td>";
              ...
              <form method='POST' class='form-horizontal' action='' enctype='multipart/form-data'>
                <div class='col-md-12'>
                  <table class='table table-condensed table-bordered table-striped'>
                    ...
                    $no = 1;
                    $tampil = mysql_query("SELECT * FROM rb_siswa a JOIN rb_jenis_kelamin b ON a.id_jenis_kelamin=b.id_jenis_kelamin where kode_kelas='$_GET[id]' AND id_kls_pararel='$_GET[ie]' ORDER BY a.id_siswa");
                    while($r=mysql_fetch_array($tampil)){
