                    ...
                    if ($_SESSION[level]=="guru") {
                      if (isset($_GET[kelas]) AND isset($_GET[tahun])){
                        $tampil = mysql_query("SELECT a.*, e.nama_kelas,m.nm_pararel, b.namamatapelajaran, b.kode_pelajaran, b.kode_kurikulum, c.nama_guru, d.nama_ruangan FROM rb_jadwal_pelajaran a 
                          ...
                          AND a.nip= '$_SESSION[id]' GROUP BY a.kode_pelajaran ORDER BY a.hari DESC");
                                                ...
                                                JOIN rb_guru c ON a.nip=c.nip 
                                                  JOIN rb_ruangan d ON a.kode_ruangan=d.kode_ruangan
                                                   ...
                                                   JOIN rb_kls_pararel m ON a.id_kls_pararel=m.id_kls_pararel 
                                                    where a.id_kls_pararel='$_GET[kelasp]' 
                            AND a.kode_kelas='$_GET[kelas]'
                                                      AND a.id_tahun_akademik='$_GET[tahun]' GROUP BY a.kode_pelajaran 
                                              ...
                                              JOIN rb_mata_pelajaran b ON a.kode_pelajaran=b.kode_pelajaran
                                                JOIN rb_guru c ON a.nip=c.nip 
                                                  JOIN rb_ruangan d ON a.kode_ruangan=d.kode_ruangan
                                                   ...
                                                   JOIN rb_kls_pararel m ON a.id_kls_pararel=m.id_kls_pararel 
                                                    where a.id_kls_pararel='$_GET[kelasp]' 
                             AND a.kode_kelas='$_GET[kelas]' AND b.kode_kurikulum='$kurikulum[kode_kurikulum]' GROUP BY a.kode_pelajaran ORDER BY a.hari DESC");
                      }
                    }
                              ...
                              if (isset($_GET[tahun]) AND isset($_GET[kelas])){
                                if($_SESSION[level]!='kepala'){
                                  echo "<td style='width:280px !important'><center>
                                          <a class='btn btn-success btn-xs' title='Lihat Nilai Pengetahuan Siswa' href='index.php?view=raport&act=listsiswa&jdwl=$r[kodejdwl]&kd=$r[kode_pelajaran]&id=$r[kode_kelas]&ie=$r[id_kls_pararel]&tahun=$_GET[tahun]'><span class='glyphicon glyphicon-th-list'></span> Pengetahuan</a>
                                          <a class='btn btn-primary btn-xs' title='Lihat Nilai Keterampilan Siswa' href='index.php?view=raport&act=listsiswaketerampilan&jdwl=$r[kodejdwl]&kd=$r[kode_pelajaran]&id=$r[kode_kelas]&ie=$r[id_kls_pararel]&tahun=$_GET[tahun]'><span class='glyphicon glyphicon-th-list'></span> Keterampilan</a>
                                          <a class='btn btn-warning btn-xs' title='Lihat Nilai Sikap Siswa' href='index.php?view=ledgermapel&act=listsiswasikap&jdwl=$r[kodejdwl]&kd=$r[kode_pelajaran]&id=$r[kode_kelas]&ie=$r[id_kls_pararel]&tahun=$_GET[tahun]'><span class='glyphicon glyphicon-th-list'></span> Sikap</a>
                                        </center></td>";
                                }
                              }
                            echo "</tr>";
...
elseif($_GET[act]=='raport_bulanan'){
cek_session_siswa();
    include "raport/raport_bulanan_siswa.php";
}
