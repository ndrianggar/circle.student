<?php 
    if (isset($_POST[simpan])){
      if ($_POST[status]=='Update'){
        ...
        mysql_query("INSERT INTO rb_nilai_pengetahuan_semester VALUES('','$_POST[jdwl]','$_GET[kdpelajaran]','$_POST[nis]','$_POST[a]','$_POST[b]','$_SESSION[id]','".date('Y-m-d H:i:s')."','$_GET[tahun]')");
                              ...
                              while($r=mysql_fetch_array($tampil)){
                                ...
                                if (isset($_POST[updatesemester])){
                                    if (trim($_POST[id])==''){
                                      ...
                                      $query = mysql_query("UPDATE rb_nilai_pengetahuan_semester SET kode_pelajaran = '$_GET[kdpelajaran]', nilai1 = '$_POST[a]', nilai2 = '$_POST[b]' where id_nilai_pengetahuan_semester='$_POST[id]'");
                                    }
