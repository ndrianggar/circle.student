    ...
    <div class='box-body table-responsive'>
      <table id='example1' class='table table-bordered table-striped table-responsive'>
        ...
        if ($cek_koreksi<$essay){
          ...
          if ($r[jenis_cbt]=="Try Out" || $r[jenis_cbt]=="Penilaian Akhir Tahun") {
            $nilai = "-";
          }else{
        ...
        echo "<tr><td>$no</td>
                  ...
                  if (($objektif+$essay)>=1){
                    if ($cek_koreksi>=$essay){
                      ...
                      $tglPembahasan = str_replace("-", "", $r["tgl_pembahasan"]);
                      $jamPembahasan = str_replace(":", "", $r["jam_pembahasan"]);
                      $wktPembahasan = $tglPembahasan.$jamPembahasan;

                      if(date('YmdHis')>=$wktPembahasan && $wktPembahasan >0){
                          echo "<a style='margin-left:3px' class='btn btn-primary btn-xs' title='Pembahasan' href='quiz_siswa_mulai.php?act=pembahasan&id_jadwal=$r[id_jadwal]'><span class='glyphicon glyphicon-th-list'></span> Pembahasan</a>";
                      }
                    ...
                    if ($r['jadwal']=='N'){ 
                      ...
                      $waktu_pembahasan = strtotime("20180909");
