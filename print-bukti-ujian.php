...
<table style='border:1px solid #000' border='0' width='100%'>
  <tr>
    <td width=120px><img style='width:75px; height:70px; margin-top:7px' src='print_raport/logo-sma-ihbs.png'></td>
    <td><center>BUKTI MENGIKUTI UJIAN<br> SMA NEGERI 1 KURIK</center></td>
    <td width=120px></td>
  </tr>
</table>
