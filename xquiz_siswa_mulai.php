                    ...
                    <form action="quiz_siswa_mulai.php?act=hasil&id_jadwal=<?php echo $_GET['id_jadwal']; ?>" method="post" id="formulir">
                        ...
                        while($row = mysql_fetch_array($jumlah)){
                            echo "<div class='tab'>
                                        ...
                                        echo "<p><span style='float:left; margin:-2px 5px 0px 0px'><input type='radio' name='jawaban$no' value='A' onclick='validateForm()'> A. </span>$row[jawab_a]</p>
                                                <p><span style='float:left; margin:-2px 5px 0px 0px'><input type='radio' name='jawaban$no' value='B' onclick='validateForm()'> B. </span>$row[jawab_b]</p>
                                                <p><span style='float:left; margin:-2px 5px 0px 0px'><input type='radio' name='jawaban$no' value='C' onclick='validateForm()'> C. </span>$row[jawab_c]</p>
                                                <p><span style='float:left; margin:-2px 5px 0px 0px'><input type='radio' name='jawaban$no' value='D' onclick='validateForm()'> D. </span>$row[jawab_d]</p>
                                                <p><span style='float:left; margin:-2px 5px 0px 0px'><input type='radio' name='jawaban$no' value='E' onclick='validateForm()'> E. </span>$row[jawab_e]</p>";
                                        }else{
