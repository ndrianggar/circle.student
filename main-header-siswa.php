<nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="index.php" class="navbar-brand"><b>CIRCLE</b> STUDENT</a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          ...
          <!--  <li><a href="index.php?view=penilaiandirisiswa"> <span>Penilaian Diri</span></a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu"role="menu">
                <li><a href="#" data-toggle="modal" data-target="#modalRaportBulanan">Raport Bulanan</a></li>
                <li><a href="#" data-toggle="modal" data-target="#modalRaportKenaikan">Raport Kenaikan</a></li>
              </ul>
            </li>
            <li><a href="index.php?view=dokumentasisiswa"> <span>Documentation</span></a></li>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Agenda Harian Muslim <span class="caret"></span></a>
                <ul class="dropdown-menu"role="menu">
          ...
          <?php }elseif ($_SESSION['level']=='parent'){ ?>
         <!--    <li><a href="index.php?view=jadwal_siswa"> Jadwal Pelajaran</a></li> -->
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Laporan Nilai <span class="caret"></span></a>
              <ul class="dropdown-menu"role="menu">
