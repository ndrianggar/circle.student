...
?>
<head>
<title>Raport Bulanan Siswa </title>
...
<body>
<img src="../dist/img/watermark_smp.pngx" class="watermark">
<?php
...
<h1 class='lembaga' style='text-align:center; font-size:33px; margin:0px; margin-bottom:10px;'>موسسة نورالعلم للدعوة الاسلامية <br><span style='font-size:25px;'>معهدابن حجر الاسلامية للمرحلة المتوسطة</span></h1>                
...
<?php 
$mapel =  mysql_query("SELECT * FROM  rb_jadwal_pelajaran a JOIN rb_mata_pelajaran b ON a.kode_pelajaran=b.kode_pelajaran where a.kode_kelas='$_GET[kelas]' AND a.id_kls_pararel = '$_GET[kelasp]' AND a.id_tahun_akademik='$_GET[tahun]' group by a.kode_pelajaran");$no = 1; $n = 0;

while ($m = mysql_fetch_array($mapel)){ 
$nilai = mysql_fetch_array(mysql_query("SELECT * FROM rb_nilai_uts where kodejdwl='$m[kodejdwl]' and nisn = '$_GET[id]' AND raport_bulan = '$_GET[bulan]'")); echo "string"; echo "
  <tr>
    <td align='center'>$no</td>
    <td align='left'>$m[namamatapelajaran_en]</td>
...
<table border=0 width=100% style="position: absolute; bottom: 0px;">
  <tr>
    <td width="260" align="left">Parents of students / الوالد</td>
    <td width="260" align="left">Homeroom Teacher /المشرف</td>
    <td width="260"align="left">Jakarta, <?php echo tgl_raport(date("Y-m-d")); ?> <br> Principal / مديرالمدرسة</td>
  </tr>
  <tr>
    <td align="left"><br /><br /><br /><br /><br /><br /><br />
      ................................... <br /><br /></td>
    <td align="left" valign="top"><br /><br /><br /><br /><br /><br/>
