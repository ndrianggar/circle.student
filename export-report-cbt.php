...
$kelas_paralel =mysql_fetch_array( mysql_query("SELECT * FROM rb_kls_pararel where kode_kelas='$_GET[kelas]' and id_kls_pararel = '$_GET[paralel]'"));
                ...
                <div class='box-body'>
                    ...
                    <table class='table table-condensed table-hover'>
                        <tbody>
                          ...
                          <tr><th scope='row'>Pilih Kelas</th>               <td style='border-bottom:1px solid #e3e3e3'> : $kelas_paralel[nm_pararel]</td></tr>
                        </tbody>
                    </table>
                    </div>
