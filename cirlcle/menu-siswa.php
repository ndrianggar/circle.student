<section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="index.php?view=bahantugas"><i class="fa fa-file"></i><span>Materi</span></a></li>
            <li><a href="index.php?view=quiz"><i class="fa fa-users"></i><span>Tugas</span></a></li>
