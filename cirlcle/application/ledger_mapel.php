          ...
          <div class='panel-body'>
            ...
            <div id='myTabContent' class='tab-content'>";
                  ...
                  // Ini Halaman unutk Penilaian
                      ...
                      echo "<div class='col-md-12'>
                            <form action='index.php?view=ledgermapel&act=listsiswasikap&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]&tahun=$_GET[tahun]&ie=$_GET[ie]' method='POST'>
                ...
                echo "<div role='tabpanel' class='tab-pane fade' id='sosial' aria-labelledby='sosial-tab'>
                      <div class='col-md-12'>
                            <form action='index.php?view=ledgermapel&act=listsiswasikap&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]&tahun=$_GET[tahun]' method='POST'>
