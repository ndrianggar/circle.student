                ...
                <div class="box-body">
                  ...
                  <?php
                    if (isset($_GET['kelas']) AND isset($_GET['id_jenis'])){
                      $tampil = mysql_query("SELECT * FROM rb_quiz_cbt where id_jenis='$_GET[id_jenis]' AND kode_kelas='$_GET[kelas]'");
                    }
                    $no = 1;
                                ...
                                echo "<td style='width:150px !important'>
                                        <div class='btn-group'>
                                          ...
                                          <ul style='border: 1px solid #e3e3e3;' class='dropdown-menu'>
                                            <li><a href='index.php?view=cbt&act=tambahcbtsoal&id_jenis=$_GET[id_jenis]&kelas=$_GET[kelas]&id_cbt=$r[id_cbt]'>Lihat / Edit</a></li>
...
if (isset($_POST['submit'])){
  mysql_query("INSERT INTO rb_quiz_cbt VALUES('','$_GET[id_jenis]','$_GET[kelas]','$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_SESSION[id]','".date('Y-m-d H:i:s')."')");
  $id = mysql_insert_id();
...
if (isset($_POST['submit'])){
  mysql_query("INSERT INTO rb_quiz_jadwal VALUES('','$_GET[id_cbt]','$_POST[a]','$_POST[b]','".tgl_simpan($_POST[c])."','$_POST[cc]','".tgl_simpan($_POST[d])."','$_POST[dd]','".date('Y-m-d H:i:s')."','$_SESSION[id]')");
                          ...
                          <table class='table table-condensed table-hover'>
                              <tbody>
                                ...
                                if ($t['jadwal']=='N'){
                                  ...
                                  echo "<tr><th scope='row'>Pembahasan</th>        <td> <input type='text' name='c' class='form-control datepickera' value='".date('d-m-Y')."' style='display:inline-block; width:50%'>  <input type='text' name='cc' class='form-control clockpickera' value='".date('H:i:s')."' style='display:inline-block; width:40%'></td></tr>
                                          <input type='hidden' name='d' class='form-control datepickerb' value='00-00-0000' style='display:inline-block; width:50%'>  
                                          <input type='hidden' name='dd' class='form-control clockpickerb' value='00-00-00' style='display:inline-block; width:40%'>
                                        </td></tr>";
                                }
                              echo "</tbody>
                          </table>
          ...
          echo "<form action='index.php?view=cbt&act=tambahcbtsoal&id_jenis=$_GET[id_jenis]&kelas=$_GET[kelas]&id_cbt=$_GET[id_cbt]' method='POST'>
                ...
                <div id='myTabContent' class='tab-content'>
                  ...
                  <table id='example' class='table table-bordered table-striped'>
                    ...
                    <tbody>";
                    $no = 1;
                    $tampil = mysql_query("SELECT * FROM rb_bank_pertanyaan_objektif where kode_pelajaran='$m[kode_pelajaran]' AND kategori_soal='objektif'");
                    echo "<input type='hidden' value='".mysql_num_rows($tampil)."' name='jumlah'>";
                    while($r=mysql_fetch_array($tampil)){
                    echo "<tr><td>$no</td>
