            ...
            <div class="col-xs-12">  
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <?php
                    if (isset($_GET[kelas])){
                      $tampil = mysql_query("SELECT a.*, e.nama_kelas,m.nm_pararel, b.namamatapelajaran, b.kode_kurikulum, b.kode_pelajaran, c.nama_guru, d.nama_ruangan FROM rb_jadwal_pelajaran a 
...
<?php 
    ...
    $d = mysql_fetch_array(mysql_query("SELECT a.kode_kelas, b.nama_kelas, c.namamatapelajaran, d.nama_guru, e.nm_pararel FROM `rb_jadwal_pelajaran` a JOIN rb_kelas b ON a.kode_kelas=b.kode_kelas JOIN rb_kls_pararel e ON a.id_kls_pararel=e.id_kls_pararel JOIN rb_mata_pelajaran c ON a.kode_pelajaran=c.kode_pelajaran JOIN rb_guru d ON a.nip=d.nip where a.kodejdwl='$_GET[id]'"));
              ...
              <div class='box'>
                ...
                <div class='box-body'>
                  ...
                  <table id='example' class='table table-bordered table-striped'>
                    ...
                    <tbody>";
                      $tampil = mysql_query("SELECT * FROM rb_kompetensi_dasar z JOIN rb_jadwal_pelajaran a ON z.kodejdwl=a.kodejdwl JOIN rb_kelas b ON a.kode_kelas=b.kode_kelas  JOIN rb_kelas m ON a.id_kls_pararel=m.id_kls_pararel JOIN rb_mata_pelajaran c ON a.kode_pelajaran=c.kode_pelajaran where a.kodejdwl='$_GET[id]' ORDER BY z.id_kompetensi_dasar DESC");
                    $no = 1;
                    while($r=mysql_fetch_array($tampil)){
                    echo "<tr><td>$no</td>
                              <td>$r[ranah]</td>
    ...
    echo "<div class='col-md-12'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='#' onclick='window.history.back()' class='btn btn-default pull-right'>Cancel</a>
    ...
    echo "<div class='col-md-12'>
                ...
                <div class='col-md-12'>
                  ...
                  <input type='hidden' name='id' value='$_GET[id]'>
                    <tr><th width='140px' scope='row'>Kelas</th>   <td><select class='form-control' name='b'>"; 
					  ...
					  <input type='hidden' name='id' value='$_GET[ie]'>
                    <tr><th width='140px' scope='row'>Kelas</th>   <td><select class='form-control' name='m'>"; 
                                                $kelasp = mysql_query("SELECT * FROM rb_kls_pararel");
                                                while($a = mysql_fetch_array($kelasp)){
                                                  if ($e[id_kls_pararel]==$a[id_kls_pararel]){
                                                    echo "<option value='$a[id_kls_pararel]' selected>$a[nm_pararel]</option>";
              ...
              <div class='box-footer'>
                    ...
                    <a href='#' onclick='window.history.back()'  type='button' class='btn btn-default pull-right'></a>
