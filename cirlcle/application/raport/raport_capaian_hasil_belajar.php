...
if ($_GET[act]==''){ 
    if (isset($_POST[simpan])){
        ...
        for ($ia=1; $ia<=$juml; $ia++){
          ...
          $nisn   = $_POST['nisn'.$ia];
          if ($a != '' OR $b != '' OR $c != '' OR $d != ''){
            $cek = mysql_num_rows(mysql_query("SELECT * FROM rb_nilai_sikap_semester where id_tahun_akademik='$_POST[tahun]' AND nisn='$nisn' AND kode_kelas='$_POST[kelas]' AND id_kls_pararel='$_POST[kelasp]'"));
            if ($cek >= '1'){
              ...
              mysql_query("INSERT INTO rb_nilai_sikap_semester VALUES('','$_POST[tahun]','$nisn','$_POST[kelas]','$_POST[kelasp]','$a','$b','$c','$d','$_SESSION[id]','".date('Y-m-d H:i:s')."')");
            }
          } 
        }
        echo "<script>document.location='index.php?view=capaianhasilbelajar&tahun=".$_POST[tahun]."&kelas=".$_POST[kelas]."&kelasp=".$_POST[kelasp]."';</script>";
    }
?> 
            <div class="col-xs-12">  
              <div class="box">
