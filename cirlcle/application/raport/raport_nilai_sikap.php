<?php 
    if (isset($_POST[simpan])){
        ...
        echo "<script>document.location='index.php?view=raport&act=listsiswasikap&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]&ie=$_GET[ie]&tahun=$_GET[tahun]';</script>";
    }
          ...
          <div class='panel-body'>
            ...
            <div id='myTabContent' class='tab-content'>";
                  ...
                  // Ini Halaman unutk Nilai Spiritual
                      ...
                      echo "<div class='col-md-12'>
                            <form action='index.php?view=raport&act=listsiswasikap&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]&ie=$_GET[ie]&tahun=$_GET[tahun]' method='POST'>
