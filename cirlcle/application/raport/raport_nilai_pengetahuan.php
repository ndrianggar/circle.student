        ...
        <div class='box-body'>
              ...
              <table class='table table-condensed table-hover'>
                  <tbody>
                    ...
                    <tr><th scope='row'>Kelas Pararel</th>               <td>$n[nm_pararel]</td></tr>
          ...
          <div class='panel-body'>
              <table class='table table-bordered table-striped'>
                              ...
                              while($r=mysql_fetch_array($tampil)){
                                  ...
                                  if ($_GET[nisn]==$r[nisn]){
                                    echo "<form action='index.php?view=raport&act=listsiswa&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]&ie=$_GET[ie]&tahun=$_GET[tahun]' method='POST'>
                                      <tr>
                                        <td>$no</td>
                                      ...
                                      echo "<tr>
                                          ...
                                          if ($_GET[nis]==$r[nisn]){
                                              ...
                                              echo "<tr>
                                                ...
                                                <td rowspan='2' align=center colspan='2'>
                                                  <a title='Ubah Nilai UTS atau UAS' href='index.php?view=raport&act=listsiswa&jdwl=$_GET[jdwl]&kd=$_GET[kd]&id=$_GET[id]&ie=$_GET[ie]&tahun=$_GET[tahun]&nis=$r[nisn]&editsemester=$sms[id_nilai_pengetahuan_semester]#$r[nisn]' class='btn btn-lg btn-default' style='margin-top:5px'><span class='glyphicon glyphicon-edit'></span></a>
                                                </td>
                                              </tr>
                                              <tr>
                                                <td></td><td></td>
