                              ...
                              if (isset($_GET[tahun]) AND isset($_GET[kelas])){
                                if($_SESSION[level]!='kepala'){
                                  echo "<td style='width:70px !important'><center>
                                          <a class='btn btn-success btn-xs' title='Lihat Siswa' href='index.php?view=raportuts&act=listsiswa&jdwl=$r[kodejdwl]&kd=$r[kode_pelajaran]&id=$r[kode_kelas]&ie=$r[id_kls_pararel]&tahun=$_GET[tahun]'><span class='glyphicon glyphicon-th-list'></span> Input Nilai</a>
                                        </center></td>
                                        <td><button class='btn btn-success btn-xs' data-toggle='modal' data-target='#myModal'>test</button></td>
                                          ...
                                          <div class='modal-dialog modal-sm'>
                                            <div class='modal-content'>
                                              ...
                                              <form  method='GET' action=''>
                                                ...
                                                <input class='form-control' type='text' name='blnRaport' id='blnRaport' autocomplete='off'>
