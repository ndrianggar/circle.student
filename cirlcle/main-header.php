                    ...
                    <div class="pull-right">
                      <?php 
                        if ($_SESSION[level]=='superuser'){
                            ...
                            echo "<a href='index.php?view=adminsekolah&act=edit&id=$_SESSION[id]' class='btn btn-default btn-flat'>Edit Profile</a>";
						}elseif ($_SESSION[level]=='adminkonten'){
                            echo "<a href='index.php?view=adminkonten&act=edit&id=$_SESSION[id]' class='btn btn-default btn-flat'>Edit Profile</a>";
